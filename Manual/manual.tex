...
\lhead{Deep indoor measurements of narrownband-IoT}
\rfoot{Page \thepage}
...
To setup the TSMW box, simple connect it to the power source and the computer. When the measurement is to be carried out, run the \texttt{get\_power\_measurements.m} script and terminate by ressing \texttt{ctrl+c}.

Pictures of a setup can be seen in figure \ref{fig:rul1} and \ref{fig:rul2}.

\begin{figure}[ht]
\centering
\includegraphics[width=0.5\textwidth]{rullebord1.jpg}
...
\hline
 & -2nd & -1st & 0th & 1st & 2nd & 3rd \\ \hline
LOS& 	&	&	&	&	&	\\ \hline
NLOS   & 	&	&	&	&	&	\\ \hline
no LOS   & 	&	&	&	&	&	\\ \hline
Windows 1 layer  & 	&	&	&	&	&	\\ \hline
Wall 1 layer  & 	&	&	&	&	&	\\ \hline
Windows 2 layer  & 	&	&	&	&	&	\\ \hline
Wall 2 layer  & 	&	&	&	&	&	\\ \hline
Windows 3 layer  & 	&	&	&	&	&	\\ \hline
Wall 3 layer  & 	&	&	&	&	&	\\ \hline
\end{tabular}

\caption{An overview of different scenarios and combinations}
\label{tab:scenarios}
\end{table}
\fi
